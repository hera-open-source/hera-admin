...
export async function generateVersion(params) {
  return request.get('http://localhost:8080/hera/scheduleCenter/generateVersion', params);
}
...
export async function getJobVersion(params) {
  return request.get('http://localhost:8080/hera/scheduleCenter/getJobVersion', params);
}
export async function manual(params) {
  return request.get('http://localhost:8080/hera/scheduleCenter/manual', params);
}

export async function updateSwitch(params) {
  return request.get('http://localhost:8080/hera/scheduleCenter/updateSwitch', params);
}
export async function deleteJob(params) {
  return request.get('http://localhost:8080/hera/scheduleCenter/deleteJob', params);
}
export async function updatePermission(params) {
  return request.get('http://localhost:8080/hera/scheduleCenter/updatePermission', params);
}
...
export async function addMonitor(params) {
  return request.get('http://localhost:8080/hera/scheduleCenter/addMonitor', params);
}
// http://localhost:8080/hera/scheduleCenter/manual?actionId=201911020300000002&triggerType=1

export async function addGroup(params) {
  return request.post('http://localhost:8080/hera/scheduleCenter/addGroup', params);
}
// http://localhost:8080/hera/scheduleCenter/addGroup  name: dddd
// directory: 0
// parentId: group_8
export async function addJob(params) {
  return request.post('http://localhost:8080/hera/scheduleCenter/addJob', params);
}

export async function getJobOperator(params) {
  return request.get('http://localhost:8080/hera/scheduleCenter/getJobOperator', params);
}
export async function updateJobMessage(params) {
  return request.get('http://localhost:8080/hera/scheduleCenter/updateJobMessage', params);
}
