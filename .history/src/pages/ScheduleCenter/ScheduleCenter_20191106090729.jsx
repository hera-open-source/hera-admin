  ...
  render() {
    ...
    return (
      <div className="schedule-center-container">
        ...
        {showJob === 0 ?
          (editable === 0 ? <JobForm onEditJob={this.onEditJob.bind(this)} jobForm={jobData} /> : <JobEditForm onBack={this.onEditGroup.bind(this)} jobForm={jobData}/>) :
          (editable === 0 ? <FolderForm onEditGroup={this.onEditGroup.bind(this)} folderForm={folderData} /> :
