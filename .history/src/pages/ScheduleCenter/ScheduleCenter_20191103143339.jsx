...
import JobEditForm from './component/JobForm/JobForm';
import FolderEditForm from './component/FolderForm/JobForm';
...
export default class ScheduleCenter extends Component {
  ...
  render() {
    const { activeKey, jobData, showJob, folderData, myTreeNodes, allTreeNodes } = this.state;
    ...
    return (
      <div className="schedule-center-container">
        ...
        {showJob === 0 ?
          <JobForm jobForm={jobData} /> : <FolderEditForm folderForm={folderData} />
        }
      </div>
    );
  }
