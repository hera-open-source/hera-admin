...
export default class ScheduleCenter extends Component {
  ...
  render() {
    const { activeKey, treeNodes, jobData, showJob, folderData ,myTreeNodes,allTreeNodes} = this.state;
        ...
        <div>
          ...
          >
            ...
            <Tab.Item title="全部调度任务" key="2">
              <FileTree dataSource={alTreeNodes} onSelect={this.onSelect.bind(this)} />
            </Tab.Item>
          </Tab>
        </div>
        {showJob === 1 ?
