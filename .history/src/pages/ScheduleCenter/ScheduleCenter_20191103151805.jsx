...
import from './component/JobEditForm/JobEditForm'
  ...
  render() {
    ...
    return (
      <div className="schedule-center-container">
        ...
        {showJob === 0 ?
          (editable === 0 ? <JobForm jobForm={jobData} /> : <FolderEditForm />) :
           (editable === 0 ? <FolderForm folderForm={folderData} /> : <FolderEditForm />)
        }
      </div>
    );
  }
