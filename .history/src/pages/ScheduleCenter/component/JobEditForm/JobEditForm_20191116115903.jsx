...
export default class JobEditForm extends Component {
  ...
  onChange = (value) => {
    console.log(value);
      ...
      this.setState({
        auto: value,
        selectTreeVisible: value === 1 ? true : false,
      });
  ...
  render() {
    const { labelAlign, selectedKeys, dataSource, auto } = this.state;
        ...
        <div>
          ...
          <Form field={this.field}>
            ...
            <Row span="8" justify="center">
              ...
              {
                auto === 0 ? (<FormItem {...formItemLayout}
                  labelAlign={labelAlign}
                  label="定时表达式:"
                >
                  ...
                  label="依赖任务:"
                >
                  <Input onFocus={this.onFocus.bind(this)} value={selectedKeys} name="configs.roll.back.wait.time" />
                </FormItem>)
              }
            ...
            {
              auto === 0 ? (<Row />) : (<Row span="8" justify="center">
