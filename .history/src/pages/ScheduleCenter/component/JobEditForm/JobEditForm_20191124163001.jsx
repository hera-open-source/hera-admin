            ...
            </FormItem>
            {
              auto === 0 ?
                <FormItem {...formItemLayout}
                  ...
                  label="定时表达式:"
                >
                  <Input name="cronExpression" onFocus={this.onFocus.bind(this, 'cron')} />
                </FormItem >
                :
                <FormItem {...formItemLayout}
                  labelAlign={labelAlign}
                  label="依赖任务:"
                >
                  <Input name="configs.roll.back.wait.time" onFocus={this.onFocusJob.bind(this, 'depend')} value={selectedKeys} />
                </FormItem>
            }
          </Row>
