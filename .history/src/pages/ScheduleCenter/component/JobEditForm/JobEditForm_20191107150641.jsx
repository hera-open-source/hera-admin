...
import { Tree, Button, Checkbox, Dialog, Input, Form, Grid, Select, Field } from '@alifd/next';
        ...
        <div>
          ...
          >
            <FormItem
              ...
              label=""
            >
              <Input.TextArea name="inheritConfig" placeholder="请输入guan'jian'z" value={Object.is(jobForm, null) ? '' : this.resolve(jobForm.inheritConfig)} />
            </FormItem>
            <div className="control-check-demo">
              ...
              <Tree defaultExpandAll checkable checkStrictly={checkStrictly} checkedKeys={checkedKeys} onCheck={this.handleCheck} dataSource={dataSource} />
            </div>
          </Dialog>
        </div>
      </div >
