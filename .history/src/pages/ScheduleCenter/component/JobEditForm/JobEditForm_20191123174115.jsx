...
import { Tree, Button, Dialog, Input, Form, Grid, Select, Field, Search } from '@alifd/next';
...
export default class JobEditForm extends Component {
  ...
  render() {
    const { labelAlign, dataSource, auto } = this.state;
    ...
    return (
      <div style={{ display: 'flex' }}>
        ...
        <Form field={this.field}>
          ...
          {
            auto === 0 ?
              <ScheduleJobForm schedulefield={this.field} /> : <DependJobForm field={this.field} />
          }
        </Form>
