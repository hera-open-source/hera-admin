...
export default class JobEditForm extends Component {
  ...
  onOk = (name) => {
    const selelctedKeys = JSON.parsewindow.localStorage.getItem('selectedKeys');
    console.log(selelctedKeys);
  ...
  onSelect = (selectedKeys) => {
    ...
    window.localStorage.setItem('selectedKeys', JSON.stringify(selectedKeys));
  }
  render() {
