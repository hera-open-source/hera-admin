        ...
        <div>
          <Form field={this.field}>
            ...
            <FormItem
              ...
              label="配置项信息"
            >
              <Input.TextArea name="configs" value={Object.is(folderForm, null) ? '' : this.resolve(folderForm.configs)}></Input.TextArea >
            </FormItem>
            <FormItem
              labelAlign="top"
              label="继承的配置项信息"
            >
              <Input.TextArea name="inheritConfig" value={Object.is(folderForm, null) ? '' : this.resolve(folderForm.inheritConfig)}></Input.TextArea>
            </FormItem>
          </Form>
        </div>
        <div>
