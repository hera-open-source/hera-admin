...
import { getGroupTask } from '../../../../api/ScheduleCenter.js';
      ...
      <div style={{ display: 'flex' }}>
        ...
        <div>
          <Dialog visible={this.state.addGroupVisible}
            onOk={this.onCreateGroup.bind(this, 'okClick')}
            // onCancel={this.onClose.bind(this, 'cancelClick')}
            onClose={this.onClose}
          ...
          >
            <Form >
              ...
              >
                ...
                <FormItem label=" ">
                  <Form.Submit type="primary" validate onClick={this.handleSubmit}>tian'jia</Form.Submit>
                </FormItem>
              </FormItem>
            </Form>
          </Dialog>
