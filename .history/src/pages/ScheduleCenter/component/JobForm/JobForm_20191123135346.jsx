...
import { getJobHistory, generateVersion } from '../../../../api/ScheduleCenter';
...
export default class JobForm extends Component {
  ...
  resolve = (configs) => {
    ...
    for (const key in configs) {
      ...
      //   }
      // } else {
      userConfigs = `${userConfigs + key}=${val}<br />`;
    }
    // }
    ...
    return JSON.stringify(userConfigs);
  }
          ...
          <Form field={this.field}>
            ...
            <div>
              <FormItem
                ...
                label="配置项信息"
              >
                <Input.TextArea value={this.resolve(jobForm.configs)} dangerouslySetInnerHTML={{ __html: {{this.resolve(jobForm.configs)} }} />
              </FormItem>
              <FormItem>
                <CodeMirror
              ...
              <FormItem
                ...
                label="继承的配置项信息"
              >
                <Input.TextArea {...init('inheritConfig', this.resolve.bind(this))} readOnly />
              </FormItem>
            </div>
          </Form>
        </div>
