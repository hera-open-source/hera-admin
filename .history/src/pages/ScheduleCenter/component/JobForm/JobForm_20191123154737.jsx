...
export default class JobForm extends Component {
  ...
  onManual = async (jobId, triggerType) => {
    ...
    const data = result.data.map(item => item.id)
    this.setState({
      versionVisible: true,
      versionDataSource: result.data,
    });
  }
  onUpdateSwitch = () => {
        ...
        <div>
          ...
          >
            <div className="demo-container">
              <Select onChange={this.onChange} dataSource={versionDataSource} aria-labelledby="select-a11y">
