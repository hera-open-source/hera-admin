          ...
          <Form field={this.field}>
            ...
            <Row>
              <FormItem {...formItemLayout}
                ...
                label="配置项信息:"
              >
                <Input.TextArea name="configs" value={Object.is(jobForm, null) ? '' : jobForm.configs}>    </Input.TextArea >
              </FormItem>
            </Row>
            <Row>
              <CodeMirror
            ...
            <Row>
              <FormItem {...formItemLayout}
                ...
                label="继承的配置项信息:"
              >
                <Input.TextArea name="inheritConfig" value={Object.is(jobForm, null) ? '' : jobForm.configs}> </Input.TextArea>
              </FormItem>
            </Row>
          </Form>
        </div>
