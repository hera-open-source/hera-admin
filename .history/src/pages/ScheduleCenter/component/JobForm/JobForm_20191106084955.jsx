...
import { Button, Dialog, Input, Form, Grid, Field, Select } from '@alifd/next';
      ...
      <div style={{ display: 'flex' }}>
        ...
        <div>
          <ul className="file-button-ul">
            ...
            <li>
              <Button onClick={this.onEditJob.bind(this, jobId)} size="medium" type="primary">编辑</Button>&emsp;
            </li>
            <li>
