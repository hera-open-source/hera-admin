      ...
      <div style={{ display: 'flex' }}>
        ...
        <div>
          <ul className="file-button-ul">
            ...
            <li>
              <Button onClick={this.onManual.bind(this, jobId,"1")} size="medium" type="primary">手动执行</Button>&emsp;
            </li>
            <li>
              <Button onClick={this.onManual.bind(this, jobId,"2")} size="medium" type="primary">手动恢复</Button>&emsp;
            </li>
            <li>
