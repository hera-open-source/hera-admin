...
import { getJobHistory, generateVersion, getJobVersion, manual, updateSwitch, deleteJob, getJobOperator } from '../../../../api/ScheduleCenter';
    ...
    return (
      <div style={{ display: 'flex' }}>
        ...
        <div>
          ...
          >
            <div className="demo-container">
              <Select onChange={this.onChange} dataSource={allUser} defaultValue="jack" aria-labelledby="select-a11y" />
            </div>
          </Dialog>
        </div>
      </div >
