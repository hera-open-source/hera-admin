...
import { Tree, Button, Tab, Icon, Dialog, Input, Form, Grid, Balloon, Field, TextArea } from '@alifd/next';
...
import { TextArea } from '@alifd/next/types/input';
    ...
    return (
      <div >
        ...
        <div className="config-form">
          <Input.TextArea> {Object.is(jobForm, null) ? '' : jobForm.configs} </Input.TextArea >
        </div>
        ...
        <Input.TextArea>  {Object.is(jobForm, null) ? '' : jobForm.inheritConfig}<Input.TextArea> 
        </div>
      </div >
    );
  }
