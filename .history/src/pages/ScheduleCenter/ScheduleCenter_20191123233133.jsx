  ...
  render() {
    ...
    return (
      <div className="schedule-center-container">
        ...
        {showJob === 0 ?
          (editable === 0 ? <JobForm onEditJob={this.onEditJob.bind(this)} jobForm={jobData} /> : <JobEditForm onBack={this.onEditJob.bind(this)} onJobTypeChange={this.j} jobForm={jobData} />) :
