  ...
  render() {
    ...
    return (
      <div className="schedule-center-container">
        ...
        {showJob === 0 ?
          (editable === 0 ? <JobForm onEditJob={this.onEditJob.bind(this)} jobForm={jobData} /> : <JobEditForm onBack={this.onEditJob.bind(this)} jobForm={jobData} />) :
          (editable === 0 ? <FolderForm onBack={this.onEditGroup.bind(this)} onEditGroup={this.onEditGroup.bind(this)} folderForm={folderData} /> :
