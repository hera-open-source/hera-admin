...
export default class DevelopCenter extends Component {
  ...
  componentDidMount() {
    let fileActiveKey = this.state.fileActiveKey;
    let filePanes = this.state.filePanes;
    window.localStorage.setItem('tabData', JSON.stringify(filePanes));
    window.localStorage.setItem('fileActiveKey', filePanes);
