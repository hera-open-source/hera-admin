      ...
      <div className="develop-center-container">
        ...
        <div className="code-zone">
          ...
          <div className="log-tab">
            ...
            <div>
              <Button onClick={this.onSaveJob} size="medium" type="primary">查看日志</Button>&emsp;
              <Button onClick={this.onSearchJobHistoru} size="medium" type="primary">历史日志</Button>&emsp;
