        ...
        <div className="code-zone">
          ...
          <div className="file-tab">
            <Tab
              ...
              size="small"
            >
              {this.state.filePanes.map(item => <Tab.Item title={item.tab} closeable={item.closeable}></Tab.Item>)}
            </Tab>
          </div >
          ...
          <div className="log-tab">
            <div>
              <Tab
                ...
                size="small"
              >
                {thostate.logPanes.map(item => <Tab.Item title={item.tab} key={item.key} closeable={item.closeable}></Tab.Item>)}
              </Tab>
            </div>
