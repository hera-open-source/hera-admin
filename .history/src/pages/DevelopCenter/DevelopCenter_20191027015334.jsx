  ...
  expandedRowRender = (record) => {
    ...
    if (Object.is(record.status, 'running')) {
      const timerHandler = window.setInterval(() => {
        ...
        window.clearInterval(timerHandler);
        return (<Scrollbars style={{ width: 800, height: 200 }}><div><p dangerouslySetInnerHTML={{ __html: `${log.data.log}` }} /></div></Scrollbars>);
      }, 2000);
    } else {
      return (<Scrollbars style={{ width: 800, height: 200 }}><div><p dangerouslySetInnerHTML={{ __html: `${record.log}` }} /></div></Scrollbars>);
    }
  }
