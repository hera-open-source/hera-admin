            ...
            <div>
              ...
              >
                ...
                >
                  ...
                  <Table.Column cell={this.operation.bind(this)} width={200} />
                </Table>
...
dataSource = () => {
  ...
  for (let i = 0; i < 5; i++) {
      result.push({
          title: {
              id: `Quotation for 1PCS Nano ${3 + i}.0 controller compatible`,
              fileId: `Quotation for 1PCS Nano ${3 + i}.0 controller compatible`
