...
export default class DevelopCenter extends Component {
  ...
  render() {
    let { fileActiveKey, logPanes } = this.state;
    let tabDataSession = window.localStorage.getItem('tabData');
    let fileActiveKeySession = window.localStorage.getItem('fileActiveKey');
