    ...
    promise.then((value) => {
      ...
      window.setInterval(() => {
        ...
        logPromise.then((logData) => {
          this.setState({ debugLog: logData.data.log });
        }, 2000);
      });
    });
  };
...
————————————————
版权声明：本文为CSDN博主「白馬嘯西風」的原创文章，遵循 CC 4.0 BY-SA 版权协议，转载请附上原文出处链接及本声明。
原文链接：https://blog.csdn.net/wdz512/article/details/87450830
      ...
      <div className="develop-center-container" >
        ...
        <div className="code-zone">
          ...
          <div className="log-tab">
            ...
            <Scrollbars
              style={{ height: 10 }}// 这里给个足够高的高度就好
              renderThumbVertical={thumbStyle}// 传入函数，设置滚动条样式
            // autoHide
            >
              <div className="log-text" dangerouslySetInnerHTML={{ __html: this.state.debugLog }} />
