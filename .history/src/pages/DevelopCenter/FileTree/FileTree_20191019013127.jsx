...
import { init, find, addFile,delete } from '../../../api/DevelopCenter.js';
  ...
  onItemClick = async (key, item, event) => {
    ...
    switch (key) {
      case '1':
        ...
        break;
      case '2':
        const params = { parent: id, type: 2, name: 'hive1..hive' };
        const promise = addFile(params);
        promise.then((value) => {
        ...
        break;
      case '3':
        const params = { parent: id, type: 2, name: 'shell1.sh' };
        const promise = addFile(params);
        promise.then((value) => {
        ...
        break;
      case '4':
        const params = { parent: id, type: 2, name: 'spark1.spark' };
        const promise = addFile(params);
        promise.then((value) => {
      ...
      const params = { id: id};
        ...
        promise.then((value) => {
          console.log('delete spark success');
        });
        this.loadData();
      // case 7:
      // case 8:
