...
export default class FileTree extends Component {
  ...
  onItemClick = async (key, item, event) => {
    ...
    switch (key) {
      case '1':
        const params = { parent: id, type: 1, name: '文件夹1' };
        const promise = addFile(params);
        promise.then((value) => {
        ...
        break;
      case '2':
        const params1 = { parent: id, type: 2, name: 'hive1..hive' };
        const promise = addFile(params1);
        promise.then((value) => {
        ...
        break;
      case '3':
        const params2 = { parent: id, type: 2, name: 'shell1.sh' };
        const promise = addFile(params2);
        promise.then((value) => {
        ...
        break;
      case '4':
        const params3 = { parent: id, type: 2, name: 'spark1.spark' };
        const promise = addFile(params3);
        promise.then((value) => {
