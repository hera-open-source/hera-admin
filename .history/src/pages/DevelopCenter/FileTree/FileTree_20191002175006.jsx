...
export default class FileTree extends Component {
  ...
  onSelect = async (selectedKeys, extra) => {
    const { node, selected } = extra;
    const id = node.props.data.id;
    this.setState({
      selectedKeys: selected ? selectedKeys : this.state.selectedKeys,
      parentId: node.props.data.leaf ? null : id
    }, () => {
      this.props.history.push(`/scenario/scene/${id}`);
    });
  };
