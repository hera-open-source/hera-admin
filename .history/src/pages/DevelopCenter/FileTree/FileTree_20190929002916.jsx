...
export default class FileTree extends Component {
    ...
    loadData = () => {
        var nodes = tree.data;
        var result = this.convertData(nodes);
        console.log(result);
        this.setState({
            nodes: result,
        });
    ...
    convertData = (data) => {
        ...
        findChildren = (data, id) => {
            ...
            for (let node of data) {
                if (node.parent == id) {
                    var nodeTemp = { label: node.name, key: node.id };
        ...
        render() {
            ...
            return (
                <div>
                    ...
                    <Tree defaultExpandAll showLine editable isLabelBlock
                        dataSource={nodes}
