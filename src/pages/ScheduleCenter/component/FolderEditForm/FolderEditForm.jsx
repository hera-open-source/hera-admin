...
import { addJob, updateGroupMessage } from '../../../../api/ScheduleCenter.js';
...
export default class FolderEditFormForm extends Component {
  ...
  onSave = async () => {
    ...
    const result = await updateGroupMessage(this.field.getValues().getValues);
    console.log(result);
  }
        ...
        <div>
          <Form field={this.field}>
            ...
            <FormItem
              ...
              label="继承的配置项信息"
            >
              <Input.TextArea name="inheritConfig" value={Object.is(folderForm, undefined) ? '' : this.resolve(folderForm.inheritConfig)} readOnly />
            </FormItem>
          </Form>
        </div>
        <div>
