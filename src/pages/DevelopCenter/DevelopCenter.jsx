        ...
        <div className="code-zone">
          ...
          <div className="file-tab">
            <Tab
              ...
              size="small"
            >
              {filePanes.map(item => <Tab.Item title={item.tab} key={item.key} closeable={item.closeable} />)}
            </Tab>
          </div >
          ...
          <div className="log-tab">
            <div>
              <Tab
                ...
                size="small"
              >
                {logPanes.map(item => <Tab.Item title={item.tab} key={item.key} closeable={item.closeable} />)}
              </Tab>
            </div>
            <Scrollbars style={{ width: 1000, height: 200 }}>
